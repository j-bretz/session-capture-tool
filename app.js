...
import { Clock, AlertTriangle, Save, FileText } from 'lucide-react';

export default function SessionCaptureTool() {
...
${sessionData.nextSteps || '[Add next steps, homework, or follow-up items]'}`;
  ...
  return (
    <div className="max-w-6xl mx-auto p-6 bg-white">
      ...
      <div className="mb-6">
        <label className="block text-sm font-medium text-gray-700 mb-2">
          Quick Notes (brief observations as they come up)
        </label>
        <textarea
          ...
          placeholder="Brief phrases about what's being discussed, client affect, key moments..."
        />
      </div>
